...
tools:
  [vscode/memory, vscode/askQuestions, execute, read, agent, browser, 'figma/*', 'io.github.chromedevtools/chrome-devtools-mcp/*', edit, search, web, vscode.mermaid-chat-features/renderMermaidDiagram, ms-azuretools.vscode-containers/containerToolsConfig, todo]
agents: ["Explore"]
handoffs:
